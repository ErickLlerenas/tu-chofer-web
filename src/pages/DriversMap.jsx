                    ...
                    markers.map((marker, key) => (
                      <Marker
                        onClick={() => {
                          Swal.fire({
                            icon: "info",
                            title: marker.tripID.serviceAccepted
                              ? "Ocupado"
                              : "Disponible",
                            html: `
                        ...
                        `,
                            ...
                            showConfirmButton: marker.tripID.serviceAccepted
                              ? false
                              : true,
                          }).then((result) => {
                        ...
                        key={key}
                        position={{
                          lat: marker.currentLocation.w_,
                          lng: marker.currentLocation.T_,
                        }}
                        icon={{
                          url: marker.tripID.serviceAccepted
                            ? NotAvailable
                            : Available,
